    ...
    constructor(props){
        ...
        this.state = {
            ...
            sideMenuList: [
                ...
                {key: 3, name: 'My Wallet', icon: 'account-balance-wallet', navigationName: 'wallet', type:'MaterialIcons', child: 'thirdChild'},
                {key: 4, name: 'My Rides', navigationName: 'RideList', icon: 'car-sports', type: 'material-community', child: 'fourthChild'},
                {key: 5, name: 'About Us',  navigationName: 'About', icon: 'info', type: 'entypo', child: 'fifthChild'},
                {key: 6, name: 'Sign Out', icon: 'sign-out', type: 'font-awesome', child: 'lastChild'}
                ],
            profile_image:null,
