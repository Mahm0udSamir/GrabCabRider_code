                ...
                <View style={styles.divCompView}>
                    <View style={styles.containsView}>
                        <View style={styles.statusStyle}>
                            ...
                            {item.type?item.type == 'Credit'?<Text style={styles.historyamounttextStyle}>{item.type + 'ed $' + item.amount.toFixed(2) + ' '+'Successfully'}</Text>:
                                <Text style={styles.historyamounttextStyle}>{item.type + 'ed $' + item.amount.toFixed(2)+ ' '+ 'form wallet'}</Text>
                            :null}
                                   
                            <Text style={styles.textStyle}>Transaction Id - {item.txRef}</Text>
