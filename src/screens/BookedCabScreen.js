          ...
          <View style={styles.alertModalInnerContainer}>
            ...
            <View style={styles.alertContainer}>
                ...
                <View style={styles.msgContainer}>
                    <Text style={styles.cancelMsgText}>Your ride with Booking Id  {this.state.currentBookingId } has been cancelled successfully</Text>
                </View>
...
:null} 
        ...
        <View style={styles.bottomContainer}>
            <View style={styles.otpContainer}>
                <Text style={styles.cabText}>You Selected - <Text style={styles.cabBoldText}>{this.state.carType}</Text></Text>
                <Text style={styles.otpText}>OTP : {this.state.otp}</Text>
        ...
        }
        {
            ...
            <View style={{flex: 1, backgroundColor: "rgba(22,22,22,0.8)", justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View><Text style={{color:colors.BLUE.default.primary,fontSize:16,marginTop:12}}>Driver will Assign Soon..</Text></View>
                <View style={styles.buttonContainer}>
                    <Button
                        title="Cancel Ride"
                        loading={false}
