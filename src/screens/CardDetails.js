  ...
  cardPayment(){
    ...
    if(this.state.payDetails && this.state.cardData){
      ...
      if(this.state.payDetails.payableAmmount > 0 && this.state.cardData.valid){
              ...
              this.state.payDetails.payableAmmount <0 ? alert('Payment amount is too small'):alert('Card is not valid')
            }
          }else{ 
        ...
        <View style={{ flex: 1, backgroundColor: "rgba(22,22,22,0.8)", justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ width: '85%', backgroundColor: "#DBD7D9", borderRadius: 10, flex: 1, maxHeight: 70 }}>
            <View style={{ alignItems: 'center', flexDirection: 'row', flex: 1, justifyContent: "center" }}>
              ...
              />
              <View style={{ flex: 1 }}>
                <Text style={{ color: "#000", fontSize: 16, }}>Please wait...</Text>
              </View>
            </View>
          </View>
        </View>
      ...
      >
        <View style={styles.containercvv}>
          <View style={styles.modalContainercvv}>
            ...
            <Text style={{marginBottom:8,fontSize:16}}>Please Enter Your CVV</Text>
              <TextInput
    ...
    return (
        <Modal
            ...
            <Header
                ...
                centerComponent={<Text style={styles.headerTitleStyle}>Your promo</Text>}
    ...
    return (
      <View style={styles.mainView}>
        <Header
          ...
          centerComponent={<Text style={styles.headerTitleStyle}>Payment</Text>}
          containerStyle={styles.headerStyle}
          innerContainerStyles={{ marginLeft: 10, marginRight: 10 }}
        />
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollStyle}>
          ...
          <View style={{flex:1,flexDirection:'row',justifyContent:'space-between', paddingLeft: 20, paddingRight: 20, marginBottom: 4}}>
            <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 22,fontWeight:'500' }}>Bill Details</Text>
            <TouchableOpacity
               onPress={() => {this.openPromoModal()}}>
            <Text style={{ color: '#018509', textAlign: 'left', lineHeight: 45, fontSize: 14,fontWeight:'500' }}>Apply Promo</Text>
              </TouchableOpacity> 
            </View>
            <View style={{flex:1,flexDirection:'row',justifyContent:'space-between', paddingLeft: 25, paddingRight: 25}}>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>Your Fare</Text>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>${this.state.payDetails.amount.toFixed(2)}</Text>
            </View>
            <View style={{flex:1,flexDirection:'row',justifyContent:'space-between', paddingLeft: 25, paddingRight: 25}}>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>Promo Discount</Text>
              <Text style={{ color: '#BB1E1E', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>- ${this.state.payDetails?this.state.payDetails.discount?this.state.payDetails.discount:'0.00':'0.00'}</Text>
            </View>
            {this.state.useWalletCash == true?
            <View style={{flex:1,flexDirection:'row',justifyContent:'space-between', paddingLeft: 25, paddingRight: 25}}>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>Wallet Discount</Text>
              <Text style={{ color: '#BB1E1E', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>- ${this.state.usedWalletAmmount?this.state.usedWalletAmmount.toFixed(2):'0.00'}</Text>
            </View>:null}
            ...
            <View style={{flex:1,flexDirection:'row',justifyContent:'space-between', paddingLeft: 25, paddingRight: 25}}>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 ,fontWeight:'500'}}>Grand Total</Text>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16,fontWeight:'500' }}>$ {this.state.payDetails.payableAmmount?(this.state.payDetails.amount - this.state.payDetails.discount).toFixed(2):0.00}</Text>
            </View>
            <View style={{flex:1,flexDirection:'row',justifyContent:'space-between', paddingLeft: 25, paddingRight: 25}}>
              <Text style={{ color: '#018509', textAlign: 'left', lineHeight: 45, fontSize: 18 ,fontWeight:'500'}}>Payable Ammount</Text>
              <Text style={{ color: '#018509', textAlign: 'left', lineHeight: 45, fontSize: 18,fontWeight:'500' }}>$ {this.state.payDetails.payableAmmount?this.state.payDetails.payableAmmount.toFixed(2):0.00}</Text>
            </View>
          </View>
            ...
            <View style={{ flex: 1 }}>
              ...
              title={'Use Wallet Cash (Your balance - $'+ this.state.walletBalance.toFixed(2) +')'}
...
:
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              ...
              <Text style={styles.buttonTitle}>Pay with cash</Text>
            </TouchableOpacity>
            ...
            <View style={{ height: 45, width: '100%', backgroundColor: '#d9d9d9', flex: 1, justifyContent: 'space-between', flexDirection: 'row', paddingLeft: 8, paddingRight: 10, marginBottom: 12 }}>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>Pay with Card</Text>
            ...
            {this.state.dropdown == false ?
              <View>
                ...
                <TouchableOpacity
                  ...
                  <Text style={styles.buttonTitle}>Proceed to Pay</Text>
                </TouchableOpacity>
              </View>
              : null}
              
             <View style={{ height: 45, width: '100%', backgroundColor: '#d9d9d9', flex: 1, justifyContent: 'space-between', flexDirection: 'row', paddingLeft: 8, paddingRight: 10, marginBottom: 12 }}>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>Your Saved Cards</Text>
