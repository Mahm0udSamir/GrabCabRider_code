                ...
                <View style={styles.alertModalContainer}>
                    <View style={styles.alertModalInnerContainer}>
                        ...
                        <View style={styles.alertContainer}>
                            ...
                            <Text style={styles.rideCancelText}>Sorry</Text>

                            <View style={styles.horizontalLLine} />

                            <View style={styles.msgContainer}>
                                <Text style={styles.cancelMsgText}>Grabcab currently doesn't support multiple bookings.</Text>
                            </View>
                                            ...
                                            if (driverData.val()) {
                                                        ...
                                                        if (allUsers[key].location) {
                                                            ...
                                                            if (originalDistance <= 10) { // Request will be send if distance less than 10 km 
                                                                if (allUsers[key].carType == this.state.carType) {
                                                                    ...
                                                                    this.sendPushNotification(allUsers[key].driverUid,bookingKey,'You Have A New Booking Request')
                                                                }
                                                            }
                                                        }
                                                ...
                                                setTimeout(() => {
                                                    if (arr.length > 0) {
                                                        ...
                                                        alert("We cannot assign driver at this moment. contact to admintrator !!");
                                                    }
                                                }, 300)
                                    ...
                                    userData.once('value', driverData => {
                                        if (driverData.val()) {
                                            ...
                                            if (arr.length > 0) {
                                                ...
                                                alert("Driver will be assign soon");
                                                this.props.navigation.navigate('BookedCab', { passData: bookingData });
                                            }
                                        }
                                    })
                    ...
                    <View style={styles.modalInnerContainer}>
                        ...
                        <View style={styles.modalInner}>
                            ...
                            <View style={styles.fareTextContainer}>
                                <Text style={styles.fareText}>Fare Details</Text>
                            </View>
                            ...
                            <View style={styles.upperContainer}>
                                <View style={styles.fareDetailsContainer}>
                                    ...
                                    <View style={styles.farePriceContainer}>
                                        <Text style={styles.farePriceText}>$ {this.state.fareCost} </Text>
                                        <Text style={styles.farePriceText}>$ {this.state.rateDetails ? this.state.rateDetails.convenience_fees.toFixed(2) : 0} </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.totalPriceContainer}>
                                    ...
                                    <View style={styles.totalPriceNumberContainer}>
                                        ...
                                        <Text style={styles.totalPriceNumber}>${this.state.estimateFare}</Text>
                                ...
                                <View style={styles.termsContainer}>
                                    <Text style={styles.termsText}> N.B.: Your fare will be increased if toll, route and destination changes or if ride took longer due to traffic orother</Text>
                                </View>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.bottomContainer}>
                       <View style={styles.offerContainer}>
                            <TouchableOpacity >
                                <Text style={styles.offerText}> This is your Estimate fare only</Text>
                            </TouchableOpacity>
                    </View>
                        ...
                        <View style={styles.priceDetailsLeft}>
                            <View style={styles.priceDetails}>
                                <View style={styles.totalFareContainer}>
                                    <Text style={styles.totalFareText}>Your Total Fare</Text>
                                </View>
                                <Icon
                                    name='info'
                                    color={colors.WHITE}
                            ...
                            <View style={styles.iconContainer}>
                                <Text style={styles.priceText}>$ {this.state.estimateFare}</Text>
                            </View>
