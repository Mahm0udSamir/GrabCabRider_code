...
export default class MapScreen extends React.Component {
           ...
           <View style={{flex: 1, backgroundColor: "rgba(22,22,22,0.8)", justifyContent: 'center', alignItems: 'center' }}>
               ...
               <View style={{ alignItems: 'center',flexDirection:'row',flex:1,justifyContent:"center"}}>
                    <Image
                       ...
                       />
                  <View style={{flex:1}}>
                           <Text style={{color:"#000",fontSize:16,}}>Finding Drivers for you</Text>
                   </View>
               </View>
               </View>
           </View>
 ...
 _getLocationAsync = async () => {
   ...
   showNoDriverAlert() {
       Alert.alert(
           'Alert!',
           'Sorry, No Drivers found right now.Please try again later',
           [
            {
              text: 'OK',
              onPress: () => this.setState({loadingModal:false}),
            },
            {text: 'Try Again', onPress: () => {this._getLocationAsync()},  style: 'cancel',},
          ],
          {cancelable: true},
       )
   }
    ...
    <Modal
        ...
        <View style={{flex: 1, backgroundColor: "rgba(22,22,22,0.8)", justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Avatar
                ...
                />
           <Text style={{color:"#0cab03",fontSize:28,textAlign:"center",position:"absolute",marginTop:170}}>Congratulations!</Text>
            <View>
                <Text style={{color:"#000",fontSize:16,marginTop:12,textAlign:"center"}}>You have got ${this.bonusAmmount} referral bonus</Text>
            </View>
    ...
    return (
      <View style={styles.mainViewStyle}>
        <Header 
            ...
            centerComponent={<Text style={styles.headerTitleStyle}>Grab My Taxi</Text>}
        ...
        <View style={styles.compViewStyle}>
            <Text style={styles.pickCabStyle}>Pick Your Travel Cab</Text>
            <Text style={styles.sampleTextStyle}>Tap to select car type and book now</Text>
            <ScrollView horizontal={true} style={styles.adjustViewStyle} showsHorizontalScrollIndicator={false}>
                ...
                <TouchableOpacity key={key} style={styles.cabDivStyle} onPress={()=>{this.selectCarType(prop,key)}} disabled={prop.minTime == ''} >
                    ...
                    <View style={styles.textViewStyle}>
                        ...
                        <Text style={styles.text2}>{prop.minTime != ''? prop.minTime : 'Not Available'}</Text>
                    </View>
                </TouchableOpacity>
