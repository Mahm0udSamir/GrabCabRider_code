                    ...
                    <View style={styles.rideDesc}>
                        ...
                        {this.state.paramData && this.state.paramData.carType?
                                <View style={[styles.userDesc,styles.avatarView]}>  
                                    ...
                                    />
                                    <View style={styles.userView}>
                                    <Text style={styles.carNoStyle}>{this.state.paramData.vehicle_number? this.state.paramData.vehicle_number:<Text>Car Number Not found</Text>}</Text>
                    ...
                    <View style={styles.billView}>
                        ...
                        <View style={styles.billOptions}>
                            <View style={styles.billItem}>
                                ...
                                <Text style={styles.billAmount}>${this.state.paramData && this.state.paramData.trip_cost>0?this.state.paramData.trip_cost.toFixed(2):this.state.paramData && this.state.paramData.estimate?this.state.paramData.estimate.toFixed(2):0 }</Text>
                            </View>
                            <View style={styles.billItem}>
                                <View>
                                    <Text style={[styles.billName, styles.billText]}>Discount</Text>
                                    <Text style={styles.taxColor}>(Promo Apply)</Text>
                                </View>
                                <Text style={styles.discountAmount}> - ${this.state.paramData && this.state.paramData.discount_amount?this.state.paramData.discount_amount.toFixed(2):0}</Text>
                            </View>
                        </View>
                        <View style={styles.paybleAmtView}>
                            <Text style={styles.billTitle}>Grand Total</Text>
                            <Text style={styles.billAmount2}>${this.state.paramData && this.state.paramData.trip_cost?this.state.paramData.trip_cost.toFixed(2):null}</Text>
                        </View>
                    </View>
                    :null:null}
                     {this.state.paramData && this.state.paramData.payment_status?this.state.paramData.payment_status == "IN_PROGRESS" || this.state.paramData.payment_status == "PAID" || this.state.paramData.payment_status == "WAITING"?
