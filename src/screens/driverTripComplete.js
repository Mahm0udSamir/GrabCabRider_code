          ...
          <View style={styles.alertModalContainer}>
            <View style={styles.alertModalInnerContainer}>
              ...
              <View style={styles.alertContainer}>
                  ...
                  <Text style={styles.rideCancelText}>Alert</Text>
  
                  <View style={styles.horizontalLLine}/>
                  
                  <View style={styles.msgContainer}>
                      <Text style={styles.cancelMsgText}>Thanks For Rating</Text>
                  </View>
        ...
        return(
            <View style={styles.mainViewStyle}>
                <Header 
                    ...
                    centerComponent={<Text style={styles.headerTitleStyle}>Receipt</Text>}
                    rightComponent={<Text style={styles.headerskip} onPress={()=>{this.skipRating()}}>Skip</Text>} 
                ...
                <View style={styles.rateViewStyle}>
                    <Text style={styles.rateViewTextStyle}>${this.state.getDetails?this.state.getDetails.trip_cost>0?this.state.getDetails.trip_cost.toFixed(2):0:null}</Text>
                </View>
                ...
                <View style={styles.tripMainView}>
                    <View style={{ flex:3.2, justifyContent:'center', alignItems:"center"}}>  
                        <View style={styles.tripSummaryStyle}>
                            ...
                            <Text style={styles.summaryText}>PLEASE RATE YOUR RIDE </Text>
